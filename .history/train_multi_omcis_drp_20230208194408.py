...
from model.drp_model.DRP_nn import Single_Omics_Regression,MultiOmicsDRP
...
if __name__ == '__main__':
    ...
    if args.use_norm_ic50 == 'True':
        weights = 'weights_norm_multi_omics'
    else: weights = 'weights_multi_omics'
    ...
    test_loader = multi_drp_loader(test_set, batch_size= 1024, shuffle = False, num_workers= args.num_workers)
    if args.use_attention:
        save_dir = 'tensorboard_atten_model_multi_omics'+ args.train_type+f'_{weights}'
    else: save_dir = 'tensorboard_model_multi_omics'+ args.train_type + f'_{weights}'
    print(save_dir)
    ...
    def train_model(parameters,model_sturcture):
        ...
        for run_id, (lr, embed_dim, batch_size, layer_num,hidden_dim,readout) in enumerate(product(*param_values)):      
            ...
            if args.use_norm_ic50 == 'True':
                results = 'results_norm_multi_omics'
            else: results = 'results_multi_omics'
    ...
    if args.use_attention:
        ...
        train_model(parameters,MultiOmicsDRP)