...
from prepare_data.DRP_loader import multi_DRP_dataset, multi_drp_loader
...
if __name__ == '__main__':
    ...
    train_set = multi_DRP_dataset(drp_idx = train_idx, drug_response_dict=drug_response_dict[train_idx],use_norm_ic50= args.use_norm_ic50)
    ...
    else: save_dir = 'tensorboard_model_multi_omics'+ args.train_type
    print(save_dir)
