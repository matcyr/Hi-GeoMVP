...
from prepare_data.DRP_loader import single_DRP_dataset
from torch.utils.data import Dataset, DataLoader
import numpy as np
from torch.utils.tensorboard import SummaryWriter
from itertools import product
from model.drp_model.DRP_nn import Single_Omics_Regression,DRP
...
#     def __init__(self, drug_atom_dict, drug_bond_dict, ge_dict, drug_response_dict, use_norm_ic50 = 'True'):
#         super(single_DRP_dataset, self).__init__()
#         self.drug_atom, self.drug_bond_dict, self.ge_dict, self.DR = drug_atom_dict, drug_bond_dict, ge_dict, drug_response_dict
...
if __name__ == '__main__':
    ...
    train_set = single_DRP_dataset(drug_atom_dict=drug_atom_dict, drug_bond_dict =drug_bond_dict, ge_dict=ge_HN_feat, drug_response_dict=drug_response_dict[train_idx],use_norm_ic50= args.use_norm_ic50)
    test_set = single_DRP_dataset(drug_atom_dict=drug_atom_dict, drug_bond_dict = drug_bond_dict, ge_dict=ge_HN_feat, drug_response_dict=drug_response_dict[test_idx],use_norm_ic50= args.use_norm_ic50)
