...
if __name__ == '__main__':
    ...
    drug_atom_dict,drug_bond_dict, _, __ = load_drug_feat()
    train_idx, test_idx = create_drp_set(type= args.train_type, train)
    ...
    train_model(args, Multi_Omics_TransRegression, train_set, test_set ,parameters)