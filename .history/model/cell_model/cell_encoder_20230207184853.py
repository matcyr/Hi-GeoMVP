...
class Cell_FAConv(torch.nn.Module): ## FAConv: Beyond Low-Frequency Information in Graph Convolutional Networks
    def __init__(self,model_config) -> None:
        super(Cell_FAConv, self).__init__()
        ...
        self.embed_1  = nn.Embedding(2,self.hidden_dim)
...
class Cell_multi_omics_Encoder(nn.Module):
    def __init__(self, model_config,use_cnn = False):
        ...
        self.mut_gnn = Cell_FAConv(model_config)
        self.cnv_gnn = Cell_FAConv(model_config)
