...
class Drug_3d_Encoder(nn.Module):
    def __init__(self,model_config):
        ...
        for i in range(self.layer_num):
            ...
            self.bond_conv.append(pyg_nn.GINEConv(nn = nn.Sequential(nn.Linear(self.embed_dim, self.embed_dim), nn.ReLU(), nn.Linear(self.embed_dim, self.embed_dim)),edge_dim=self.embed_dim))
