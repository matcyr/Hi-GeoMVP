...
class drug_classfication_dataset(Dataset):
    def __init__(self):
        ...
        self.drug_atom, self.drug_bond_dict, self.target_drug, self.pathway, self.drug_threshold = drug_atom_dict, drug_bond_dict, target_drug, pathway, drug_response_binary
