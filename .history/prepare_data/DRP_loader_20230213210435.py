...
class drug_classfication_dataset(Dataset):
    def __init__(self,drug_idx):
        ...
        self.drug_atom, self.drug_bond_dict, self.target_drug, self.drug_threshold, self.name = drug_atom_dict, drug_bond_dict, drug_target_pathway, drug_threshold, drug_name
