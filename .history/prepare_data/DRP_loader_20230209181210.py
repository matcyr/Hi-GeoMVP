...
class multi_DRP_dataset(Dataset):
    def __init__(self, drp_idx ,use_norm_ic50 = 'True'):
        ...
        self.drug_atom, self.drug_bond_dict, self.ge_dict, self.cnv_dict, self.mut_dict, self.DR = drug_atom_dict[drp_idx], drug_bond_dict, ge_HN_feat, cnv_dict, mut_dict, drug_response_dict
