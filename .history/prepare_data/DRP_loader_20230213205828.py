...
class drug_classfication_dataset(Dataset, drug_idx):
    def __init__(self):
        super(drug_classfication_dataset, self).__init__()
        self.drug_atom, self.drug_bond_dict, self.target_drug, self.drug_threshold = drug_atom_dict, drug_bond_dict, drug_target_pathway, drug_threshold
...
if __name__ == '__main__':
    train_drug_set = drug_classfication_dataset(drug_name = drug_name, drug_threshold = drug_threshold, drug_atom_dict = drug_atom_dict, drug_bond_dict = drug_bond_dict, target_drug = target_drug)