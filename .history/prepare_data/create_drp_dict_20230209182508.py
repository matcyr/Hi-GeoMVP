...
def read_dr_dict():
    drug_response_dict = np.load('./Data/DRP_dataset/drug_response.npy',allow_pickle=True)
    drug_name = np.load('./Data/DRP_dataset/drug_name.npy',allow_pickle=True)
    cell_name = np.load('./Data/DRP_dataset/cell_name.npy',allow_pickle=True)
    return drug_response_dict, drug_name, cell_name
...
if __name__ == '__main__':
    ...
    path_drug_id_name = './Data/GDSC_data/drugid_name.txt'
